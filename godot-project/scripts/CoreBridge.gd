...
const A_BUTTON = InputBindings.A_BUTTON
const B_BUTTON = InputBindings.B_BUTTON
const SELECT_BUTTON = InputBindings.SELECT_BUTTON
const START_BUTTON = InputBindings.START_BUTTON
const DPAD_RIGHT = InputBindings.DPAD_RIGHT
const DPAD_LEFT = InputBindings.DPAD_LEFT
const DPAD_UP = InputBindings.DPAD_UP
const DPAD_DOWN = InputBindings.DPAD_DOWN
const R_BUTTON = InputBindings.R_BUTTON
const L_BUTTON = InputBindings.L_BUTTON

const ENTITY_RING = ENTITY_TYPES.ENTITY_RING
const ENTITY_SPRING = ENTITY_TYPES.ENTITY_SPRING
const ENTITY_ENEMY = ENTITY_TYPES.ENTITY_ENEMY
const ENTITY_CHECKPOINT = ENTITY_TYPES.ENTITY_CHECKPOINT
const ENTITY_GOAL = ENTITY_TYPES.ENTITY_GOAL
const ENTITY_SPECIAL_RING = ENTITY_TYPES.ENTITY_SPECIAL_RING
const ENTITY_WHIRLWIND = ENTITY_TYPES.ENTITY_WHIRLWIND
const ENTITY_FAN = ENTITY_TYPES.ENTITY_FAN
const ENTITY_SPIKES = ENTITY_TYPES.ENTITY_SPIKES
const ENTITY_ITEM_BOX = ENTITY_TYPES.ENTITY_ITEM_BOX
const ENTITY_PROPELLER = ENTITY_TYPES.ENTITY_PROPELLER
const ENTITY_BOOSTER = ENTITY_TYPES.ENTITY_BOOSTER
const ENTITY_DASH_RING = ENTITY_TYPES.ENTITY_DASH_RING
const ENTITY_GRIND_RAIL = ENTITY_TYPES.ENTITY_GRIND_RAIL
const ENTITY_GRAVITY_TOGGLE = ENTITY_TYPES.ENTITY_GRAVITY_TOGGLE
const ENTITY_BOUNCY_SPRING = ENTITY_TYPES.ENTITY_BOUNCY_SPRING
const ENTITY_CONVEYOR = ENTITY_TYPES.ENTITY_CONVEYOR
const ENTITY_BUZZER = ENTITY_TYPES.ENTITY_BUZZER
const ENTITY_BALLOON = ENTITY_TYPES.ENTITY_BALLOON
const ENTITY_PROJECTILE = ENTITY_TYPES.ENTITY_PROJECTILE
const ENTITY_BULLET_BUZZER = ENTITY_TYPES.ENTITY_BULLET_BUZZER
const ENTITY_KOURA = ENTITY_TYPES.ENTITY_KOURA
const ENTITY_STAR = ENTITY_TYPES.ENTITY_STAR
const ENTITY_KIKI = ENTITY_TYPES.ENTITY_KIKI
const ENTITY_KIKI_PROJECTILE = ENTITY_TYPES.ENTITY_KIKI_PROJECTILE
const ENTITY_KIKI_PIECE = ENTITY_TYPES.ENTITY_KIKI_PIECE
const ENTITY_BOSS = ENTITY_TYPES.ENTITY_BOSS
const ENTITY_SCATTER_RING = ENTITY_TYPES.ENTITY_SCATTER_RING
const ENTITY_TRAPPED_ANIMAL = ENTITY_TYPES.ENTITY_TRAPPED_ANIMAL
const ENTITY_RING_EFFECT = ENTITY_TYPES.ENTITY_RING_EFFECT
const ENTITY_HEART_EFFECT = ENTITY_TYPES.ENTITY_HEART_EFFECT
const ENTITY_DUST_EFFECT = ENTITY_TYPES.ENTITY_DUST_EFFECT
const ENTITY_GRIND_EFFECT = ENTITY_TYPES.ENTITY_GRIND_EFFECT
const ENTITY_CHEESE = ENTITY_TYPES.ENTITY_CHEESE
const ENTITY_TAIL_SWIPE = ENTITY_TYPES.ENTITY_TAIL_SWIPE
const ENTITY_KNUCKLES_FIRE = ENTITY_TYPES.ENTITY_KNUCKLES_FIRE
const ENTITY_SONIC_SKID = ENTITY_TYPES.ENTITY_SONIC_SKID
const ENTITY_LAYER_TOGGLE = ENTITY_TYPES.ENTITY_LAYER_TOGGLE
const ENTITY_RAMP = ENTITY_TYPES.ENTITY_RAMP
const ENTITY_ROTATING_HANDLE = ENTITY_TYPES.ENTITY_ROTATING_HANDLE
const ENTITY_CORK_SCREW = ENTITY_TYPES.ENTITY_CORK_SCREW
const ENTITY_CANNON = ENTITY_TYPES.ENTITY_CANNON
const ENTITY_LAUNCHER = ENTITY_TYPES.ENTITY_LAUNCHER
const ENTITY_PIPE_START = ENTITY_TYPES.ENTITY_PIPE_START
const ENTITY_PIPE_END = ENTITY_TYPES.ENTITY_PIPE_END
const ENTITY_HOOK_RAIL = ENTITY_TYPES.ENTITY_HOOK_RAIL
const ENTITY_SLIDY_ICE = ENTITY_TYPES.ENTITY_SLIDY_ICE
const ENTITY_LIGHT_BRIDGE = ENTITY_TYPES.ENTITY_LIGHT_BRIDGE
const ENTITY_SLOWING_SNOW = ENTITY_TYPES.ENTITY_SLOWING_SNOW
const ENTITY_SPIKE_PLATFORM = ENTITY_TYPES.ENTITY_SPIKE_PLATFORM
const ENTITY_TURNAROUND_BAR = ENTITY_TYPES.ENTITY_TURNAROUND_BAR
const ENTITY_KEYBOARD = ENTITY_TYPES.ENTITY_KEYBOARD
const ENTITY_POLE = ENTITY_TYPES.ENTITY_POLE
const ENTITY_LIGHT_GLOBE = ENTITY_TYPES.ENTITY_LIGHT_GLOBE
const ENTITY_WINDUP_STICK = ENTITY_TYPES.ENTITY_WINDUP_STICK
const ENTITY_GERMAN_FLUTE = ENTITY_TYPES.ENTITY_GERMAN_FLUTE
const ENTITY_SMALL_WINDMILL = ENTITY_TYPES.ENTITY_SMALL_WINDMILL
const ENTITY_CHORD = ENTITY_TYPES.ENTITY_CHORD
const ENTITY_HALF_PIPE = ENTITY_TYPES.ENTITY_HALF_PIPE
const ENTITY_IRON_BALL = ENTITY_TYPES.ENTITY_IRON_BALL
const ENTITY_CRANE = ENTITY_TYPES.ENTITY_CRANE
const ENTITY_CEILING_SLOPE = ENTITY_TYPES.ENTITY_CEILING_SLOPE
const ENTITY_GAPPED_LOOP = ENTITY_TYPES.ENTITY_GAPPED_LOOP
const ENTITY_FUNNEL_SPHERE = ENTITY_TYPES.ENTITY_FUNNEL_SPHERE
const ENTITY_MUSIC_ENTRY = ENTITY_TYPES.ENTITY_MUSIC_ENTRY
const ENTITY_DAMAGE_REGION = ENTITY_TYPES.ENTITY_DAMAGE_REGION
const ENTITY_DECORATION = ENTITY_TYPES.ENTITY_DECORATION
const ENTITY_NOTE_BLOCK = ENTITY_TYPES.ENTITY_NOTE_BLOCK
const ENTITY_NOTE_SPHERE = ENTITY_TYPES.ENTITY_NOTE_SPHERE
const ENTITY_FLYING_HANDLE = ENTITY_TYPES.ENTITY_FLYING_HANDLE
const ENTITY_NOTE_PARTICLE = ENTITY_TYPES.ENTITY_NOTE_PARTICLE
const ENTITY_LAP_TRIGGER = ENTITY_TYPES.ENTITY_LAP_TRIGGER
const ENTITY_GOAL_LEVER = ENTITY_TYPES.ENTITY_GOAL_LEVER
...
const SOURCE_ENTITY_LOADER := preload("res://scripts/core/SourceEntityLoader.gd")
...
const LEVEL_BUILDER := preload("res://scripts/core/LevelBuilder.gd")
const PLATFORM_MOTION := preload("res://scripts/core/PlatformMotionSystem.gd")
const PLATFORM_COLLISION := preload("res://scripts/core/PlatformCollisionSystem.gd")
const ENTITY_INTERACTION_DISPATCHER := preload("res://scripts/core/EntityInteractionDispatcher.gd")
const ENEMY_MOTION_DISPATCHER := preload("res://scripts/core/EnemyMotionDispatcher.gd")
const STAGE_MECHANISM_STATE_SYSTEM := preload("res://scripts/core/StageMechanismStateSystem.gd")
...
const CLEAR_RESULT_COUNTER_SYSTEM := preload("res://scripts/core/ClearResultCounterSystem.gd")
const ENEMY_MOTION_SYSTEM := preload("res://scripts/core/EnemyMotionSystem.gd")
const BOSS_MOTION_SYSTEM := preload("res://scripts/core/BossMotionSystem.gd")
const CAMERA_MOTION_SYSTEM := preload("res://scripts/core/CameraMotionSystem.gd")
const INPUT_BUFFER_SYSTEM := preload("res://scripts/core/InputBufferSystem.gd")
...
const COURSE_SELECT_PRESENTER := preload("res://scripts/ui/CourseSelectPresenter.gd")
const MULTIPLAYER_RESULTS_PRESENTER := preload("res://scripts/ui/MultiplayerResultsPresenter.gd")
const MULTIPLAYER_LOBBY_PRESENTER := preload("res://scripts/ui/MultiplayerLobbyPresenter.gd")
const CHARACTER_SELECT_PRESENTER := preload("res://scripts/ui/CharacterSelectPresenter.gd")
const TINY_CHAO_PRESENTER := preload("res://scripts/ui/TinyChaoPresenter.gd")
const PLAY_MODE_PRESENTER := preload("res://scripts/ui/PlayModePresenter.gd")
const SINGLE_PLAYER_MENU_PRESENTER := preload("res://scripts/ui/SinglePlayerMenuPresenter.gd")
const MULTIPLAYER_MODE_PRESENTER := preload("res://scripts/ui/MultiplayerModePresenter.gd")
const TIME_ATTACK_MODE_PRESENTER := preload("res://scripts/ui/TimeAttackModePresenter.gd")
const PAUSE_PRESENTER := preload("res://scripts/ui/PausePresenter.gd")
const MULTIPLAYER_COMM_PRESENTER := preload("res://scripts/ui/MultiplayerCommPresenter.gd")
const NAME_ENTRY_PRESENTER := preload("res://scripts/ui/NameEntryPresenter.gd")
const TOUCH_CONTROLS_PRESENTER := preload("res://scripts/ui/TouchControlsPresenter.gd")
const EFFECT_MOTION_SYSTEM := preload("res://scripts/core/EffectMotionSystem.gd")
const COMPANION_MOTION_SYSTEM := preload("res://scripts/core/CompanionMotionSystem.gd")
const ENTITY_VISUAL_CATALOG := preload("res://scripts/core/EntityVisualCatalog.gd")
const STAGE_BACKDROP_CATALOG := preload("res://scripts/core/StageBackdropCatalog.gd")
const SOUND_TEST_CATALOG := preload("res://scripts/core/SoundTestCatalog.gd")
const CHARACTER_CATALOG := preload("res://scripts/core/CharacterCatalog.gd")
const SPECIAL_STAGE_CATALOG := preload("res://scripts/core/SpecialStageCatalog.gd")
...
const TOUCH_CONTROLS_OVERRIDE_SETTING := RUNTIME_SETTINGS.TOUCH_CONTROLS_OVERRIDE_SETTING
...
const GAME_STATE_PAUSED = FLOW_STATES.GAME_STATE_PAUSED
const GAME_STATE_SAVE_OPTIONS = FLOW_STATES.GAME_STATE_SAVE_OPTIONS
const GAME_STATE_INTRO = FLOW_STATES.GAME_STATE_INTRO
const GAME_STATE_CHARACTER_SELECT = FLOW_STATES.GAME_STATE_CHARACTER_SELECT
const GAME_STATE_GAME_OVER = FLOW_STATES.GAME_STATE_GAME_OVER
const GAME_STATE_CHAOS_EMERALDS = FLOW_STATES.GAME_STATE_CHAOS_EMERALDS
const GAME_STATE_TO_BE_CONTINUED = FLOW_STATES.GAME_STATE_TO_BE_CONTINUED
const GAME_STATE_SEGA_LOGO = FLOW_STATES.GAME_STATE_SEGA_LOGO
const GAME_STATE_SONIC_TEAM = FLOW_STATES.GAME_STATE_SONIC_TEAM
const GAME_STATE_CREDITS = FLOW_STATES.GAME_STATE_CREDITS
const GAME_STATE_MISSING_EMERALDS = FLOW_STATES.GAME_STATE_MISSING_EMERALDS
const GAME_STATE_COPYRIGHT = FLOW_STATES.GAME_STATE_COPYRIGHT
const GAME_STATE_SPECIAL_STAGE = FLOW_STATES.GAME_STATE_SPECIAL_STAGE
const ENDING_VARIANT_NORMAL = FLOW_STATES.ENDING_VARIANT_NORMAL
const ENDING_VARIANT_FINAL = FLOW_STATES.ENDING_VARIANT_FINAL
const ENDING_VARIANT_EXTRA = FLOW_STATES.ENDING_VARIANT_EXTRA
const GAME_STATE_CREDITS_END = FLOW_STATES.GAME_STATE_CREDITS_END
const GAME_STATE_CHARACTER_UNLOCK = FLOW_STATES.GAME_STATE_CHARACTER_UNLOCK
const GAME_STATE_FINAL_INTRO = FLOW_STATES.GAME_STATE_FINAL_INTRO
...
const TITLE_PHASE_PRESS_START = FLOW_STATES.TITLE_PHASE_PRESS_START
const TITLE_PHASE_PLAY_MODE = FLOW_STATES.TITLE_PHASE_PLAY_MODE
const TITLE_PHASE_SINGLE_PLAYER = FLOW_STATES.TITLE_PHASE_SINGLE_PLAYER
const TITLE_PHASE_MULTI_PLAYER = FLOW_STATES.TITLE_PHASE_MULTI_PLAYER
const TITLE_PHASE_TIME_ATTACK = FLOW_STATES.TITLE_PHASE_TIME_ATTACK
const TITLE_PHASE_TINY_CHAO_GARDEN = FLOW_STATES.TITLE_PHASE_TINY_CHAO_GARDEN
const TITLE_PHASE_MULTI_CONNECT = FLOW_STATES.TITLE_PHASE_MULTI_CONNECT
const TITLE_PHASE_TINY_CHAO_SETUP = FLOW_STATES.TITLE_PHASE_TINY_CHAO_SETUP
const TITLE_PHASE_SINGLEPAK_SYNC = FLOW_STATES.TITLE_PHASE_SINGLEPAK_SYNC
const TITLE_PHASE_SINGLEPAK_RESULTS = FLOW_STATES.TITLE_PHASE_SINGLEPAK_RESULTS
const TITLE_PHASE_MULTIPLAYER_LOBBY = FLOW_STATES.TITLE_PHASE_MULTIPLAYER_LOBBY
const TITLE_PHASE_TIME_ATTACK_LOBBY = FLOW_STATES.TITLE_PHASE_TIME_ATTACK_LOBBY
const TITLE_PHASE_COURSE_SELECT = FLOW_STATES.TITLE_PHASE_COURSE_SELECT
const TITLE_PHASE_MULTIPLAYER_OUTCOME = FLOW_STATES.TITLE_PHASE_MULTIPLAYER_OUTCOME
const TITLE_PHASE_TINY_CHAO_GARDEN_PLAY = FLOW_STATES.TITLE_PHASE_TINY_CHAO_GARDEN_PLAY
const OPTIONS_MODE_MAIN = FLOW_STATES.OPTIONS_MODE_MAIN
const OPTIONS_MODE_PLAYER_DATA = FLOW_STATES.OPTIONS_MODE_PLAYER_DATA
const OPTIONS_MODE_LANGUAGE = FLOW_STATES.OPTIONS_MODE_LANGUAGE
const OPTIONS_MODE_BUTTON_CONFIG = FLOW_STATES.OPTIONS_MODE_BUTTON_CONFIG
const OPTIONS_MODE_SOUND_TEST = FLOW_STATES.OPTIONS_MODE_SOUND_TEST
const OPTIONS_MODE_TIME_RECORDS = FLOW_STATES.OPTIONS_MODE_TIME_RECORDS
const OPTIONS_MODE_MULTI_RECORDS = FLOW_STATES.OPTIONS_MODE_MULTI_RECORDS
const OPTIONS_MODE_NAME_ENTRY = FLOW_STATES.OPTIONS_MODE_NAME_ENTRY
const OPTIONS_MODE_DIFFICULTY = FLOW_STATES.OPTIONS_MODE_DIFFICULTY
const OPTIONS_MODE_TIME_LIMIT = FLOW_STATES.OPTIONS_MODE_TIME_LIMIT
const OPTIONS_MODE_DELETE_CONFIRM = FLOW_STATES.OPTIONS_MODE_DELETE_CONFIRM
const OPTIONS_MODE_DELETE_CONFIRM_FINAL = FLOW_STATES.OPTIONS_MODE_DELETE_CONFIRM_FINAL
const TIME_RECORDS_VIEW_MODE_CHOICE = FLOW_STATES.TIME_RECORDS_VIEW_MODE_CHOICE
const TIME_RECORDS_VIEW_COURSES = FLOW_STATES.TIME_RECORDS_VIEW_COURSES
const TIME_RECORDS_CONTEXT_OPTIONS = FLOW_STATES.TIME_RECORDS_CONTEXT_OPTIONS
const TIME_RECORDS_CONTEXT_TIME_ATTACK = FLOW_STATES.TIME_RECORDS_CONTEXT_TIME_ATTACK
const SOUND_TEST_STATE_STOPPED = FLOW_STATES.SOUND_TEST_STATE_STOPPED
const SOUND_TEST_STATE_PLAYING = FLOW_STATES.SOUND_TEST_STATE_PLAYING
const MULTIPLAYER_RESULTS_MODE_CHARACTER_SELECTION = FLOW_STATES.MULTIPLAYER_RESULTS_MODE_CHARACTER_SELECTION
const MULTIPLAYER_RESULTS_MODE_COURSE_COMPLETE = FLOW_STATES.MULTIPLAYER_RESULTS_MODE_COURSE_COMPLETE
const CHARACTER_SELECT_CONTEXT_GAME_START = FLOW_STATES.CHARACTER_SELECT_CONTEXT_GAME_START
const CHARACTER_SELECT_CONTEXT_TIME_ATTACK_ZONE = FLOW_STATES.CHARACTER_SELECT_CONTEXT_TIME_ATTACK_ZONE
const CHARACTER_SELECT_CONTEXT_TIME_ATTACK_BOSS = FLOW_STATES.CHARACTER_SELECT_CONTEXT_TIME_ATTACK_BOSS
const CHARACTER_SELECT_CONTEXT_MULTIPLAYER = FLOW_STATES.CHARACTER_SELECT_CONTEXT_MULTIPLAYER
const NAME_ENTRY_MATRIX_COLS = FLOW_STATES.NAME_ENTRY_MATRIX_COLS
const NAME_ENTRY_MATRIX_ROWS = FLOW_STATES.NAME_ENTRY_MATRIX_ROWS
const NAME_ENTRY_MATRIX_VISIBLE_ROWS = FLOW_STATES.NAME_ENTRY_MATRIX_VISIBLE_ROWS
const NAME_ENTRY_CONTROL_ROW_BACK = FLOW_STATES.NAME_ENTRY_CONTROL_ROW_BACK
const NAME_ENTRY_CONTROL_ROW_FORWARD = FLOW_STATES.NAME_ENTRY_CONTROL_ROW_FORWARD
const NAME_ENTRY_CONTROL_ROW_END = FLOW_STATES.NAME_ENTRY_CONTROL_ROW_END
const NAME_ENTRY_CONTROLS_COL = FLOW_STATES.NAME_ENTRY_CONTROLS_COL

var _player_state: PlayerState = PlayerState.new()
var _camera_motion_system: CameraMotionSystem = CAMERA_MOTION_SYSTEM.new()
...
func _advance_clear_count_step() -> void:
	...
	_apply_clear_counter_state(state, bool(state.counting_done))

func _finish_clear_counting(fast_forward: bool = false) -> void:
	var state := CLEAR_RESULT_COUNTER_SYSTEM.finish(_clear_time_bonus_remaining, _clear_ring_bonus_remaining, _clear_special_ring_bonus_remaining, _clear_total_display_score, CLEAR_RESULT_FAST_TAIL_SECONDS, CLEAR_RESULT_TAIL_SECONDS, fast_forward)
...
func _apply_clear_counter_state(state: Dictionary, update_input_lock: bool = true) -> void:
	...
	_clear_total_display_score = int(state.total_score)
	_clear_count_step_accumulator = 0.0
	_clear_counting_done = bool(state.counting_done)
...
func _open_credits() -> void:
	...
	_credits_page = 0
	_credits_timer = CREDITS_CATALOG.intro_duration()
...
func _advance_credits_page() -> void:
	...
	if _credits_page >= _credits_page_count:
		_open_credits_end()
		return
	_credits_timer = CREDITS_CATALOG.slide_duration()
...
func _open_special_stage() -> void:
	SPECIAL_STAGE_SYSTEM.open_special_stage(self)

func _advance_special_stage() -> void:
	SPECIAL_STAGE_SYSTEM.advance_special_stage(self)

func _update_special_stage_run(delta: float, held_input: int, frame_input: int = 0) -> void:
	SPECIAL_STAGE_SYSTEM.update_special_stage_run(self, delta, held_input, frame_input)

func _update_special_stage_guard_robo(delta: float) -> void:
	SPECIAL_STAGE_SYSTEM.update_special_stage_guard_robo(self, delta)

func _update_special_stage_results(_delta: float) -> void:
	SPECIAL_STAGE_SYSTEM.update_special_stage_results(self, _delta)
...
func get_hud_time_text() -> String:
	return HUD_STATE_PRESENTER.time_text(self)

func is_hud_timer_warning() -> bool:
	return HUD_STATE_PRESENTER.timer_warning(self)

func get_hud_special_ring_count() -> int:
	return HUD_STATE_PRESENTER.special_ring_count(self)

func get_hud_special_ring_text() -> String:
	return HUD_STATE_PRESENTER.special_ring_text(self)

func get_hud_race_start_text() -> String:
	return HUD_STATE_PRESENTER.race_start_text(self)

func get_hud_boss_title_text(health: int, max_health: int) -> String:
	return HUD_STATE_PRESENTER.boss_title_text(self, health, max_health)

func get_hud_boss_phase_text(phase: String) -> String:
	return HUD_STATE_PRESENTER.boss_phase_text(self, phase)

func get_hud_multiplayer_start_flag_text() -> String:
	return HUD_STATE_PRESENTER.multiplayer_start_flag_text(self)

func get_hud_multiplayer_finish_flag_text() -> String:
	return HUD_STATE_PRESENTER.multiplayer_finish_flag_text(self)

func get_hud_powerup_text() -> String:
	return HUD_STATE_PRESENTER.powerup_text(self)

func is_hud_shield_active() -> bool:
	return HUD_STATE_PRESENTER.shield_active(self)

func is_player_magnetic_shielded() -> bool:
	return HUD_STATE_PRESENTER.magnetic_shielded(self)

func is_player_invincible() -> bool:
	return HUD_STATE_PRESENTER.invincible(self)

func is_player_speed_up_active() -> bool:
	return HUD_STATE_PRESENTER.speed_up_active(self)
...
func _build_level(level_id: int) -> LevelState:
	var level := LEVEL_BUILDER.build(level_id, _level_names[clampi(level_id, 0, _level_names.size() - 1)], _time_attack_boss_mode, _selected_level_index, _enemy_speed)
	_apply_source_entities(level)
	return level

func _apply_source_entities(level: LevelState) -> void:
	SOURCE_ENTITY_LOADER.new().apply(level, _source_map_manifest, _player_state, _checkpoint_time)
...
func _source_surface_at(terrain: Dictionary, source_x: int, source_height: int, collision_layer: int) -> int:
	return SOURCE_ENTITY_LOADER._source_surface_at(terrain, source_x, source_height, collision_layer)

func _add_platform(level: LevelState, x: float, y: float, width: float, thickness: float) -> void:
	PLATFORM_BUILDER.add_platform(level, x, y, width, thickness)
...
func _add_sloped_platform(level: LevelState, x1: float, y1: float, x2: float, y2: float, thickness: float, collision_layer: int = -1) -> void:
	PLATFORM_BUILDER.add_sloped_platform(level, x1, y1, x2, y2, thickness, collision_layer)

func _add_crumbling_platform(level: LevelState, x: float, y: float, width: float, thickness: float, delay: float = 0.5) -> void:
	PLATFORM_BUILDER.add_crumbling_platform(level, x, y, width, thickness, delay)
...
func _update_note_particle_state(delta: float) -> void:
	STAGE_MOTION_SYSTEM.update_note_particles(_level_state, delta)

func _update_half_pipe_state(frame_input: int) -> void:
	_velocity_y = STAGE_TRAVERSAL_SYSTEM.update_half_pipes(_level_state, _player_state, frame_input, _velocity_y, _jump_speed)

func _update_iron_ball_state(delta: float) -> void:
	STAGE_MOTION_SYSTEM.update_iron_balls(_level_state, delta)

func _update_crane_state(delta: float) -> void:
	_velocity_y = STAGE_TRAVERSAL_SYSTEM.update_cranes(_level_state, _player_state, delta, _velocity_y)

func _update_ceiling_slope_state(delta: float) -> void:
	STAGE_TRAVERSAL_SYSTEM.update_ceiling_slopes(_level_state, _player_state, delta)

func _update_gapped_loop_state(delta: float) -> void:
	_velocity_y = STAGE_TRAVERSAL_SYSTEM.update_gapped_loops(_level_state, _player_state, delta, _velocity_y)

func _update_funnel_sphere_state(delta: float) -> void:
	_velocity_y = STAGE_TRAVERSAL_SYSTEM.update_funnel_spheres(_level_state, _player_state, delta, _velocity_y)

func _update_music_entry_state(delta: float) -> void:
	_velocity_y = STAGE_TRAVERSAL_SYSTEM.update_music_entries(_level_state, _player_state, delta, _velocity_y)

func _music_entry_duration(is_pipe: bool, kind: int) -> float:
	return STAGE_TRAVERSAL_SYSTEM.music_entry_duration(is_pipe, kind)
...
func _update_enemy_motion(delta: float) -> void:
	ENEMY_MOTION_DISPATCHER.update(self, _level_state, delta)

func _update_pen_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_pen(entity, _player_state.world_x, delta)

func _update_gohla_motion(entity: EntityState, delta: float) -> void:
	STAGE_MOTION_SYSTEM.update_gohla(entity, delta)

func _update_kura_kura_motion(entity: EntityState, delta: float) -> void:
	STAGE_MOTION_SYSTEM.update_kura_kura(entity, delta)

func _kura_kura_fireball_position(entity: EntityState) -> Vector2:
	return STAGE_MOTION_SYSTEM.kura_kura_fireball_position(entity)

func _update_bell_motion(entity: EntityState, delta: float) -> void:
	STAGE_MOTION_SYSTEM.update_bell(entity, delta)

func _update_mouse_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_mouse(entity, _player_state.world_x, delta)

func _update_circus_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_circus(entity, delta, Callable(self, "_spawn_circus_projectile"))

func _update_yado_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_yado(entity, _player_state.world_x, delta, Callable(self, "_spawn_yado_projectile"))

func _spawn_circus_projectile(source: EntityState) -> void:
	var projectile := _add_entity(_level_state, ENTITY_PROJECTILE, source.world_x, source.world_y - 0.125)
...
func _update_hammerhead_motion(entity: EntityState, delta: float) -> void:
	STAGE_MOTION_SYSTEM.update_hammerhead(entity, delta)

func _update_straw_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_straw(entity, Vector2(_player_state.world_x, _player_state.world_y), delta)

func _update_gejigeji_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_gejigeji(entity, delta)

func _update_kubinaga_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_kubinaga(entity, Vector2(_player_state.world_x, _player_state.world_y), delta, Callable(self, "_spawn_kubinaga_projectile"))
...
func _update_madillo_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_madillo(entity, Vector2(_player_state.world_x, _player_state.world_y), delta)

func _update_kyura_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_kyura(entity, delta, Callable(self, "_spawn_kyura_projectile"))
...
func _update_flickey_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_flickey(entity, _level_state.ground_y, delta)

func _update_mon_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_mon(entity, Vector2(_player_state.world_x, _player_state.world_y), delta)

func _update_buzzer_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_buzzer(entity, Vector2(_player_state.world_x, _player_state.world_y), _player_state.is_alive, delta)

func _update_balloon_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_balloon(entity, delta, Callable(self, "_spawn_balloon_projectile"))

func _update_item_box_effect(entity: EntityState, delta: float) -> void:
	EFFECT_MOTION_SYSTEM.update_item_box(entity, delta, Callable(self, "_apply_item_box_effect"))
...
func _update_scattered_ring(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_scattered_ring(entity, _level_state.ground_y, _level_state.min_x, _level_state.max_x, delta)

func _update_bullet_buzzer_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_bullet_buzzer(entity, delta, Callable(self, "_spawn_bullet_buzzer_projectiles"))

func _update_koura_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_koura(entity, delta)

func _update_star_motion(entity: EntityState, delta: float) -> void:
	STAGE_MOTION_SYSTEM.update_star(entity, delta)

func _update_kiki_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_kiki(entity, delta, Callable(self, "_spawn_kiki_projectile"))

func _update_pikopiko_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_pikopiko(entity, _level_state.ground_y, delta)

func _update_kiki_projectile(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_kiki_projectile(entity, _level_state.ground_y, delta, Callable(self, "_split_kiki_projectile"))

func _update_kiki_piece(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_kiki_piece(entity, _level_state.max_y, delta)

func _update_trapped_animal_motion(entity: EntityState, delta: float) -> void:
	ENEMY_MOTION_SYSTEM.update_trapped_animal(entity, delta)

func _update_ring_effect_motion(entity: EntityState, delta: float) -> void:
	EFFECT_MOTION_SYSTEM.update_ring(entity, delta)

func _update_heart_effect_motion(entity: EntityState, delta: float) -> void:
	EFFECT_MOTION_SYSTEM.update_heart(entity, delta)

func _update_dust_effect_motion(entity: EntityState, delta: float) -> void:
	EFFECT_MOTION_SYSTEM.update_dust(entity, delta)
...
func _update_cheese_motion(entity: EntityState, delta: float) -> void:
	var active := COMPANION_MOTION_SYSTEM.update_cheese(entity, Vector2(_player_state.world_x, _player_state.world_y), _facing_direction, _player_state.variant, _run_from_multiplayer, _player_state.is_alive, delta)
	if not active and _cheese_entity == entity:
		_cheese_entity = null
...
func _update_character_attack_effect(entity: EntityState, delta: float) -> void:
	EFFECT_MOTION_SYSTEM.update_character_attack(entity, delta)
...
func _update_aero_egg_motion(entity: EntityState, delta: float) -> void:
	BOSS_MOTION_SYSTEM.update_aero_egg(self, _level_state, entity, _elapsed_time, delta)

func _update_hammer_tank_motion(entity: EntityState, delta: float) -> void:
	BOSS_MOTION_SYSTEM.update_hammer_tank(self, _level_state, _player_state, entity, delta)

func _hammer_tank_tip(entity: EntityState) -> Vector2:
	return BOSS_MOTION_SYSTEM.hammer_tank_tip(entity)

func _update_bomber_tank_motion(entity: EntityState, delta: float) -> void:
	BOSS_MOTION_SYSTEM.update_bomber_tank(self, _level_state, _player_state, entity, delta)

func _update_totem_boss_motion(entity: EntityState, delta: float) -> void:
	BOSS_MOTION_SYSTEM.update_totem(self, _level_state, _player_state, entity, delta)

func _update_saucer_boss_motion(entity: EntityState, delta: float) -> void:
	BOSS_MOTION_SYSTEM.update_saucer(_player_state, entity, _elapsed_time, delta)

func _saucer_beam_hits_player(entity: EntityState) -> bool:
	return BOSS_MOTION_SYSTEM.saucer_beam_hits_player(_player_state, entity)

func _update_go_round_boss_motion(entity: EntityState, delta: float) -> void:
	BOSS_MOTION_SYSTEM.update_go_round(self, _level_state, _player_state, entity, delta)

func _update_frog_boss_motion(entity: EntityState, delta: float) -> void:
	BOSS_MOTION_SYSTEM.update_frog(self, _level_state, entity, delta)

func _update_super_robo_z_motion(entity: EntityState, delta: float) -> void:
	BOSS_MOTION_SYSTEM.update_super_robo_z(self, _level_state, entity, delta)

func _update_true_area_53_boss_motion(entity: EntityState, delta: float) -> void:
	BOSS_MOTION_SYSTEM.update_true_area_53(self, _level_state, entity, _elapsed_time, delta)

func _update_boss_motion(entity: EntityState, delta: float) -> void:
	BOSS_MOTION_SYSTEM.update_generic(self, _level_state, _player_state, entity, delta)
...
func _update_platform_motion(delta: float) -> void:
	_velocity_y = PLATFORM_MOTION.update(_level_state, _player_state, delta, _player_half_width, _player_half_height, _gravity_inverted, _velocity_y)


func _start_crumbling_platform(platform: PlatformState) -> void:
	PLATFORM_COLLISION._start_crumbling_platform(platform)
...
func _handle_entity_interactions(held_input: int, frame_input: int, delta: float) -> void:
	ENTITY_INTERACTION_DISPATCHER.dispatch(self, _level_state, held_input, frame_input, delta)
...
func _update_flying_handle_state(delta: float) -> void:
	STAGE_TRAVERSAL_SYSTEM.update_flying_handles(_level_state, _player_state, delta)
...
func _update_camera() -> void:
	...
	_camera_motion_system.update_camera(_level_state, _player_state, viewport)
...
func _request_screen_shake(amplitude: float, duration: float, phase_speed: float, horizontal: bool, vertical: bool, random_value: bool) -> void:
	_camera_motion_system.request_shake(amplitude, duration, phase_speed, horizontal, vertical, random_value)

func _update_screen_shake(delta: float) -> void:
	_camera_motion_system.update_shake(delta)

func _clear_screen_shake() -> void:
	_camera_motion_system.clear_shake()

func _reset_input_buffer() -> void:
	_input_buffer_system.reset(INPUT_BUFFER_FRAMES)

func _record_input_frame(frame_input: int) -> void:
	_input_buffer_system.record(frame_input, INPUT_BUFFER_FRAMES)

func get_recent_input_mask(window: int = INPUT_BUFFER_FRAMES) -> int:
	return _input_buffer_system.recent_mask(window)
...
func get_hud_titles() -> Dictionary:
	return HUD_STATE_PRESENTER.titles(self)

func get_hud_character_short_name(character_variant: int) -> String:
	return HUD_STATE_PRESENTER.character_short_name(character_variant)

func get_hud_chrome_colors() -> Dictionary:
	return HUD_STATE_PRESENTER.chrome_colors(self)
...
func should_show_player_visual() -> bool:
	return PLAYER_VISUAL_PRESENTER.should_show(self)

func get_player_visual_palette() -> Array:
	return PLAYER_VISUAL_PRESENTER.palette()

func get_player_visual_color(variant: int, cleared: bool = false) -> Color:
	return PLAYER_VISUAL_PRESENTER.color(self, variant, cleared)

func get_title_text() -> String:
	return _title_text

func is_touch_device() -> bool:
	return TOUCH_CONTROLS_PRESENTER.is_touch_device(self)
...
func should_show_touch_controls() -> bool:
	return TOUCH_CONTROLS_PRESENTER.show_controls(self)

func should_show_touch_gameplay_controls() -> bool:
	return TOUCH_CONTROLS_PRESENTER.show_gameplay(self)

func should_show_touch_menu_controls() -> bool:
	return TOUCH_CONTROLS_PRESENTER.show_menu(self)

func should_show_touch_menu_horizontal_controls() -> bool:
	return TOUCH_CONTROLS_PRESENTER.show_menu_horizontal(self)
...
func _localize_touch_label(label: String) -> String:
	return LOCALIZATION_CATALOG.touch_label(_language_index, label)
...
func get_navigation_label() -> String:
	return TOUCH_CONTROLS_PRESENTER.navigation_label(self)

func get_confirm_label() -> String:
	return TOUCH_CONTROLS_PRESENTER.confirm_label(self)

func get_secondary_label() -> String:
	return TOUCH_CONTROLS_PRESENTER.secondary_label(self)

func get_back_label() -> String:
	return TOUCH_CONTROLS_PRESENTER.back_label(self)
...
func _reset_name_entry_navigation() -> void:
	# Present actual printable keys, not the source font-glyph IDs (C099, C100,
	# etc.). The cursor still starts at the first empty name slot.
...
func get_play_mode_rows() -> Array:
	return PLAY_MODE_PRESENTER.rows(self)

func get_play_mode_title_text() -> String:
	return PLAY_MODE_PRESENTER.title_text(self)

func get_play_mode_prompt_text() -> String:
	return PLAY_MODE_PRESENTER.prompt_text(self)

func get_play_mode_detail_text() -> String:
	return PLAY_MODE_PRESENTER.detail_text(self)

func get_play_mode_info_text() -> String:
	return PLAY_MODE_PRESENTER.info_text(self)

func get_play_mode_summary_text() -> String:
	return PLAY_MODE_PRESENTER.summary_text(self)

func get_play_mode_badge_text() -> String:
	return PLAY_MODE_PRESENTER.badge_text(self)

func get_play_mode_chrome_colors() -> Dictionary:
	return PLAY_MODE_PRESENTER.chrome_colors(self)

func get_single_player_rows() -> Array:
	return SINGLE_PLAYER_MENU_PRESENTER.rows(self)

func get_single_player_title_text() -> String:
	return SINGLE_PLAYER_MENU_PRESENTER.title_text(self)

func get_single_player_prompt_text() -> String:
	return SINGLE_PLAYER_MENU_PRESENTER.prompt_text(self)

func get_single_player_detail_text() -> String:
	return SINGLE_PLAYER_MENU_PRESENTER.detail_text(self)

func get_single_player_info_text() -> String:
	return SINGLE_PLAYER_MENU_PRESENTER.info_text(self)

func get_single_player_summary_title() -> String:
	return SINGLE_PLAYER_MENU_PRESENTER.summary_title(self)

func get_single_player_summary_text() -> String:
	return SINGLE_PLAYER_MENU_PRESENTER.summary_text(self)

func get_single_player_chrome_colors() -> Dictionary:
	return SINGLE_PLAYER_MENU_PRESENTER.chrome_colors(self)

func get_multiplayer_mode_rows() -> Array:
	return MULTIPLAYER_MODE_PRESENTER.rows(self)

func get_multiplayer_mode_title_text() -> String:
	return MULTIPLAYER_MODE_PRESENTER.title_text(self)

func get_multiplayer_mode_prompt_text() -> String:
	return MULTIPLAYER_MODE_PRESENTER.prompt_text(self)

func get_multiplayer_mode_summary_text() -> String:
	return MULTIPLAYER_MODE_PRESENTER.summary_text(self)

func get_multiplayer_mode_detail_text() -> String:
	return MULTIPLAYER_MODE_PRESENTER.detail_text(self)

func get_multiplayer_mode_info_text() -> String:
	return MULTIPLAYER_MODE_PRESENTER.info_text(self)

func get_multiplayer_mode_badge_text() -> String:
	return MULTIPLAYER_MODE_PRESENTER.badge_text(self)

func is_multiplayer_link_mode() -> bool:
	return _title_menu_index == 0

func get_multiplayer_mode_chrome_colors() -> Dictionary:
	return MULTIPLAYER_MODE_PRESENTER.chrome_colors(self)

func get_time_attack_mode_rows() -> Array:
	return TIME_ATTACK_MODE_PRESENTER.rows(self)

func get_time_attack_mode_title_text() -> String:
	return TIME_ATTACK_MODE_PRESENTER.title_text(self)

func get_time_attack_mode_prompt_text() -> String:
	return TIME_ATTACK_MODE_PRESENTER.prompt_text(self)

func get_time_attack_mode_detail_text() -> String:
	return TIME_ATTACK_MODE_PRESENTER.detail_text(self)

func get_time_attack_mode_summary_text() -> String:
	return TIME_ATTACK_MODE_PRESENTER.summary_text(self)

func get_time_attack_mode_info_text() -> String:
	return TIME_ATTACK_MODE_PRESENTER.info_text(self)

func get_tiny_chao_rows() -> Array:
	return TINY_CHAO_PRESENTER.rows(self)

func get_tiny_chao_title_text() -> String:
	return TINY_CHAO_PRESENTER.title_text(self)

func get_tiny_chao_prompt_text() -> String:
	return TINY_CHAO_PRESENTER.prompt_text(self)

func get_tiny_chao_detail_text() -> String:
	return TINY_CHAO_PRESENTER.detail_text(self)

func get_tiny_chao_summary_text() -> String:
	return TINY_CHAO_PRESENTER.summary_text(self)

func get_tiny_chao_status_title_text() -> String:
	return TINY_CHAO_PRESENTER.status_title(self)

func get_tiny_chao_badge_text() -> String:
	return TINY_CHAO_PRESENTER.badge_text(self)

func get_tiny_chao_info_rows() -> Array:
	return TINY_CHAO_PRESENTER.info_rows(self)

func get_tiny_chao_language_text() -> String:
	return TINY_CHAO_PRESENTER.language_text(self)
...
func get_multiplayer_comm_title() -> String:
	return MULTIPLAYER_COMM_PRESENTER.title(self)

func get_multiplayer_comm_prompt() -> String:
	return MULTIPLAYER_COMM_PRESENTER.prompt(self)

func get_multiplayer_comm_prompt_color() -> Color:
	return MULTIPLAYER_COMM_PRESENTER.prompt_color(self)

func get_multiplayer_comm_detail_text() -> String:
	return MULTIPLAYER_COMM_PRESENTER.detail(self)

func get_multiplayer_comm_info_text() -> String:
	return MULTIPLAYER_COMM_PRESENTER.info(self)

func get_multiplayer_comm_summary_text() -> String:
	return MULTIPLAYER_COMM_PRESENTER.summary(self)

func get_multiplayer_comm_signal_text() -> String:
	return MULTIPLAYER_COMM_PRESENTER.signal_text(self)

func get_multiplayer_comm_section_text() -> String:
	return MULTIPLAYER_COMM_PRESENTER.section_text(self)

func get_multiplayer_comm_chrome_colors() -> Dictionary:
	return MULTIPLAYER_COMM_PRESENTER.chrome_colors(self)
...
func get_boss_hud_state() -> Dictionary:
	return HUD_STATE_PRESENTER.boss_state(self)

func get_time_attack_lobby_title() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.title(self)

func get_time_attack_lobby_prompt() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.prompt(self)

func get_time_attack_lobby_detail() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.detail(self)

func get_time_attack_lobby_summary_text() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.summary_text(self)

func get_time_attack_lobby_character_text() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.character_text(self)

func get_time_attack_lobby_course_text() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.course_text(self)

func get_time_attack_lobby_mode_text() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.mode_text(self)

func get_time_attack_lobby_record_text() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.record_text(self)

func get_time_attack_lobby_record_label_text() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.record_label_text(self)

func get_time_attack_lobby_course_badge_text() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.course_badge_text(self)

func get_time_attack_lobby_focus_text() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.focus_text(self)

func get_time_attack_lobby_character_accent_color() -> Color:
	return TIME_ATTACK_LOBBY_PRESENTER.character_accent_color(self)

func get_time_attack_lobby_emblem_text() -> String:
	return TIME_ATTACK_LOBBY_PRESENTER.emblem_text(self)

func get_time_attack_lobby_chrome_colors() -> Dictionary:
	return TIME_ATTACK_LOBBY_PRESENTER.chrome_colors(self)
...
func get_course_select_title() -> String:
	return COURSE_SELECT_PRESENTER.title(self)

func get_course_select_prompt() -> String:
	return COURSE_SELECT_PRESENTER.prompt(self)

func get_course_select_detail() -> String:
	return COURSE_SELECT_PRESENTER.detail(self)

func get_course_select_summary_text() -> String:
	return COURSE_SELECT_PRESENTER.summary_text(self)

func get_course_select_banner_text() -> String:
	return COURSE_SELECT_PRESENTER.banner_text(self)
...
func get_course_select_act_label() -> String:
	return COURSE_SELECT_PRESENTER.act_label(self)

func get_course_select_type_label() -> String:
	return COURSE_SELECT_PRESENTER.type_label(self)

func get_course_select_emerald_rows() -> Array:
	return COURSE_SELECT_PRESENTER.emerald_rows(self)
...
func get_multiplayer_results_title() -> String:
	return MULTIPLAYER_RESULTS_PRESENTER.title(self)
...
func get_multiplayer_results_prompt() -> String:
	return MULTIPLAYER_RESULTS_PRESENTER.prompt(self)

func get_multiplayer_results_detail() -> String:
	return MULTIPLAYER_RESULTS_PRESENTER.detail(self)

func get_multiplayer_results_summary_text() -> String:
	return MULTIPLAYER_RESULTS_PRESENTER.summary(self)

func get_multiplayer_results_badge_text() -> String:
	return MULTIPLAYER_RESULTS_PRESENTER.badge(self)

func get_multiplayer_results_chrome_colors() -> Dictionary:
	return MULTIPLAYER_RESULTS_PRESENTER.chrome_colors(self)

func get_multiplayer_result_option_rows() -> Array:
	return MULTIPLAYER_RESULTS_PRESENTER.option_rows(self)
...
func get_multiplayer_lobby_prompt() -> String:
	return MULTIPLAYER_LOBBY_PRESENTER.prompt(self)

func get_multiplayer_lobby_detail() -> String:
	return MULTIPLAYER_LOBBY_PRESENTER.detail(self)

func get_multiplayer_lobby_info_text() -> String:
	return MULTIPLAYER_LOBBY_PRESENTER.info_text(self)

func get_multiplayer_lobby_summary_text() -> String:
	return MULTIPLAYER_LOBBY_PRESENTER.summary_text(self)

func get_multiplayer_lobby_badge_text() -> String:
	return MULTIPLAYER_LOBBY_PRESENTER.badge_text(self)

func get_multiplayer_lobby_section_text() -> String:
	return MULTIPLAYER_LOBBY_PRESENTER.section_text(self)

func get_multiplayer_lobby_chrome_colors() -> Dictionary:
	return MULTIPLAYER_LOBBY_PRESENTER.chrome_colors(self)

func get_multiplayer_lobby_option_rows() -> Array:
	return MULTIPLAYER_LOBBY_PRESENTER.option_rows(self)
...
func get_character_select_summary_text() -> String:
	return CHARACTER_SELECT_PRESENTER.summary_text(self)

func get_character_select_chrome_colors() -> Dictionary:
	return CHARACTER_SELECT_PRESENTER.chrome_colors(self)

func get_character_select_context_label() -> String:
	return CHARACTER_SELECT_PRESENTER.context_label(self)

func get_character_select_title_text() -> String:
	return CHARACTER_SELECT_PRESENTER.title_text(self)

func get_character_select_prompt_text() -> String:
	return CHARACTER_SELECT_PRESENTER.prompt_text(self)

func get_character_select_detail_text() -> String:
	return CHARACTER_SELECT_PRESENTER.detail_text(self)

func get_character_select_status_text(index: int) -> String:
	return CHARACTER_SELECT_PRESENTER.status_text(self, index)

func _get_character_description_text(index: int) -> String:
	return CHARACTER_SELECT_PRESENTER.description(self, index)
...
func get_pause_text() -> String:
	return PAUSE_PRESENTER.pause_text(self)

func get_pause_title_text() -> String:
	return PAUSE_PRESENTER.title_text(self)

func get_pause_prompt_text() -> String:
	return PAUSE_PRESENTER.prompt_text(self)

func get_pause_detail_text() -> String:
	return PAUSE_PRESENTER.detail_text(self)

func get_pause_summary_text() -> String:
	return PAUSE_PRESENTER.summary_text(self)

func get_pause_badge_text() -> String:
	return PAUSE_PRESENTER.badge_text(self)
...
func get_options_menu_items() -> Array:
	return OPTIONS_PRESENTER.menu_items(self)
...
func get_options_display_items() -> Array:
	return OPTIONS_PRESENTER.display_items(self)

func get_player_data_menu_items() -> Array:
	return OPTIONS_PRESENTER.player_data_menu_items(self)

func get_options_screen_title() -> String:
	return OPTIONS_PRESENTER.screen_title(self)

func get_options_screen_subtitle() -> String:
	return OPTIONS_PRESENTER.screen_subtitle(self)

func get_options_summary_text() -> String:
	return OPTIONS_PRESENTER.summary_text(self)

func get_options_main_title_text() -> String:
	return OPTIONS_PRESENTER.main_title(self)

func get_options_main_prompt_text() -> String:
	return OPTIONS_PRESENTER.main_prompt(self)

func get_options_main_detail_text() -> String:
	return OPTIONS_PRESENTER.main_detail(self)

func get_player_data_title_text() -> String:
	return OPTIONS_PRESENTER.player_data_title(self)

func get_player_data_prompt_text() -> String:
	return OPTIONS_PRESENTER.player_data_prompt(self)

func get_player_data_detail_text() -> String:
	return OPTIONS_PRESENTER.player_data_detail(self)

func get_player_data_header_text() -> String:
	return OPTIONS_PRESENTER.player_data_header(self)

func get_player_data_slot_text() -> String:
	return OPTIONS_PRESENTER.player_data_slot(self)

func get_player_data_summary_text() -> String:
	return OPTIONS_PRESENTER.player_data_summary(self)

func get_difficulty_title_text() -> String:
	return OPTIONS_PRESENTER.difficulty_title(self)

func get_difficulty_prompt_text() -> String:
	return OPTIONS_PRESENTER.difficulty_prompt(self)

func get_difficulty_summary_text() -> String:
	return OPTIONS_PRESENTER.difficulty_summary(self)

func get_difficulty_detail_text() -> String:
	return OPTIONS_PRESENTER.difficulty_detail(self)

func get_difficulty_rows() -> Array:
	return OPTIONS_PRESENTER.difficulty_rows(self)

func get_difficulty_chrome_colors() -> Dictionary:
	return OPTIONS_PRESENTER.difficulty_chrome_colors(self)

func get_time_limit_title_text() -> String:
	return OPTIONS_PRESENTER.time_limit_title(self)

func get_time_limit_prompt_text() -> String:
	return OPTIONS_PRESENTER.time_limit_prompt(self)

func get_time_limit_summary_text() -> String:
	return OPTIONS_PRESENTER.time_limit_summary(self)

func get_time_limit_detail_text() -> String:
	return OPTIONS_PRESENTER.time_limit_detail(self)

func get_time_limit_rows() -> Array:
	return OPTIONS_PRESENTER.time_limit_rows(self)

func get_time_limit_chrome_colors() -> Dictionary:
	return OPTIONS_PRESENTER.time_limit_chrome_colors(self)

func get_delete_confirm_title_text() -> String:
	return OPTIONS_PRESENTER.delete_confirm_title(self)

func get_delete_confirm_prompt_text() -> String:
	return OPTIONS_PRESENTER.delete_confirm_prompt(self)

func get_delete_confirm_summary_text() -> String:
	return OPTIONS_PRESENTER.delete_confirm_summary(self)

func get_delete_confirm_detail_text() -> String:
	return OPTIONS_PRESENTER.delete_confirm_detail(self)

func get_delete_confirm_rows() -> Array:
	return OPTIONS_PRESENTER.delete_confirm_rows(self)
...
func get_name_entry_detail_text() -> String:
	return NAME_ENTRY_PRESENTER.detail_text(self)

func get_name_entry_title_text() -> String:
	return NAME_ENTRY_PRESENTER.title_text(self)

func get_name_entry_prompt_text() -> String:
	return NAME_ENTRY_PRESENTER.prompt_text(self)

func get_name_entry_guide_text() -> String:
	return NAME_ENTRY_PRESENTER.guide_text(self)

func get_name_entry_preview_title_text() -> String:
	return NAME_ENTRY_PRESENTER.preview_title_text(self)
...
func get_name_entry_chrome_colors() -> Dictionary:
	return NAME_ENTRY_PRESENTER.chrome_colors(self)
...
func get_name_entry_control_label() -> String:
	return NAME_ENTRY_PRESENTER.control_label(self)

func get_name_entry_control_rows() -> Array:
	return NAME_ENTRY_PRESENTER.control_rows(self)
...
func get_name_entry_matrix_rows() -> Array:
	...
	for row in range(NAME_ENTRY_MATRIX_VISIBLE_ROWS):
		...
		for col in range(NAME_ENTRY_MATRIX_COLS):
			...
			if index < _profile_name_chars.size():
				row_chars.append(str(_profile_name_chars[index]))
			else:
				row_chars.append("")
...
func get_language_summary_text() -> String:
	return OPTIONS_PRESENTER.language_summary(self)

func get_language_title_text() -> String:
	return OPTIONS_PRESENTER.language_title(self)

func get_language_prompt_text() -> String:
	return OPTIONS_PRESENTER.language_prompt(self)

func get_language_detail_text() -> String:
	return OPTIONS_PRESENTER.language_detail(self)

func get_language_chrome_colors() -> Dictionary:
	return OPTIONS_PRESENTER.language_chrome_colors(self)

func get_button_config_summary_text() -> String:
	return OPTIONS_PRESENTER.button_config_summary(self)

func get_button_config_title_text() -> String:
	return OPTIONS_PRESENTER.button_config_title(self)

func get_button_config_prompt_text() -> String:
	return OPTIONS_PRESENTER.button_config_prompt(self)

func get_button_config_detail_text() -> String:
	return OPTIONS_PRESENTER.button_config_detail(self)

func get_button_config_chrome_colors() -> Dictionary:
	return OPTIONS_PRESENTER.button_config_chrome_colors(self)
...
func get_button_config_badge_text() -> String:
	return OPTIONS_PRESENTER.button_config_badge(self)
...
func _move_name_entry_cursor_horizontal(direction: int) -> void:
	if _is_name_entry_control_cursor():
		...
		return
	# The printable board has four rows; expose the three control buttons from
	# either horizontal edge of its final row.
	if direction < 0 and _name_entry_cursor_col == 0 and _name_entry_cursor_row == NAME_ENTRY_MATRIX_VISIBLE_ROWS - 1:
		_name_entry_cursor_col = NAME_ENTRY_CONTROLS_COL
		_name_entry_cursor_row = NAME_ENTRY_CONTROL_ROW_BACK
	elif direction > 0 and _name_entry_cursor_col == NAME_ENTRY_MATRIX_COLS - 1 and _name_entry_cursor_row == NAME_ENTRY_MATRIX_VISIBLE_ROWS - 1:
		_name_entry_cursor_col = NAME_ENTRY_CONTROLS_COL
		_name_entry_cursor_row = NAME_ENTRY_CONTROL_ROW_BACK
	else:
...
func enter_name_entry_character(character: String) -> bool:
	if _game_state != GAME_STATE_SAVE_OPTIONS or _options_mode != OPTIONS_MODE_NAME_ENTRY:
		return false
	var printable := character.to_upper()
	var character_index := _profile_name_chars.find(printable)
	if character_index < 0:
		return false
	_name_entry_matrix_page_index = 0
	_name_entry_cursor_row = int(character_index / NAME_ENTRY_MATRIX_COLS)
	_name_entry_cursor_col = character_index % NAME_ENTRY_MATRIX_COLS
	_apply_name_entry_selected_cell()
	update_save_menu_status()
	return true

func activate_name_entry_control(control_index: int) -> bool:
	if _game_state != GAME_STATE_SAVE_OPTIONS or _options_mode != OPTIONS_MODE_NAME_ENTRY:
		return false
	if control_index < 0 or control_index > NAME_ENTRY_CONTROL_ROW_END - NAME_ENTRY_CONTROL_ROW_BACK:
		return false
	_name_entry_cursor_col = NAME_ENTRY_CONTROLS_COL
	_name_entry_cursor_row = NAME_ENTRY_CONTROL_ROW_BACK + control_index
	accept_save_selection()
	return true
...
func get_sound_test_tempo() -> float:
	...
	return SOUND_TEST_CATALOG.tempo_for_song(int(entry.get("song_number", 1)))

func get_difficulty_text() -> String:
	match _difficulty_index:
		0:
			return _language_text("NORMAL", "NORMAL", "NORMAL", "NORMAL", "NORMALE")
		1:
			return _language_text("HARD", "SCHWER", "DIFFICILE", "DIFICIL", "DIFFICILE")
		_:
			return _language_text("EASY", "EINFACH", "FACILE", "FACIL", "FACILE")
...
func get_clear_title_text() -> String:
	return CLEAR_RESULTS_PRESENTER.title_text(self)
...
func get_clear_prompt_text() -> String:
	return CLEAR_RESULTS_PRESENTER.prompt_text(self)

func get_clear_detail_text() -> String:
	return CLEAR_RESULTS_PRESENTER.detail_text(self)

func get_clear_footer_text() -> String:
	return CLEAR_RESULTS_PRESENTER.footer_text(self)

func get_clear_result_heading_text() -> String:
	return CLEAR_RESULTS_PRESENTER.result_heading_text(self)

func get_clear_result_badge_text() -> String:
	return CLEAR_RESULTS_PRESENTER.result_badge_text(self)
...
func get_clear_stage_label() -> String:
	return CLEAR_RESULTS_PRESENTER.stage_label(self)

func _get_time_attack_record_text() -> String:
	return CLEAR_RESULTS_PRESENTER.time_attack_record_text(self)

func get_clear_time_attack_record_status_text() -> String:
	return CLEAR_RESULTS_PRESENTER.record_status_text(self)

func get_clear_time_attack_best_text() -> String:
	return CLEAR_RESULTS_PRESENTER.best_text(self)

func get_game_over_title_text() -> String:
	return GAME_OVER_PRESENTER.title_text(self)

func get_game_over_primary_word() -> String:
	return GAME_OVER_PRESENTER.primary_word(self)
...
func get_game_over_prompt_text() -> String:
	return GAME_OVER_PRESENTER.prompt_text(self)
...
func get_game_over_status_text() -> String:
	return GAME_OVER_PRESENTER.status_text(self)

func get_game_over_progress() -> float:
	return GAME_OVER_PRESENTER.progress(self)

func get_game_over_slide_offset() -> float:
	return GAME_OVER_PRESENTER.slide_offset(self)
...
func get_to_be_continued_title_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.to_be_continued_title(self)

func get_to_be_continued_prompt_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.to_be_continued_prompt(self)

func get_to_be_continued_detail_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.to_be_continued_detail(self)

func get_sega_logo_title_text() -> String:
	return "SEGA"

func get_sega_logo_prompt_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.sega_prompt(self)

func get_sega_logo_detail_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.sega_detail(self)
...
func get_sonic_team_logo_prompt_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.sonic_team_prompt(self)

func get_sonic_team_logo_detail_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.sonic_team_detail(self)

func get_sonic_team_logo_source_tilemap() -> String:
	return "intro_created_by_sonic_team"

func get_credits_title_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.credits_title(self)

func get_credits_page_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.credits_page_text(self)

func get_credits_source_tilemap() -> String:
	return ENDING_PRESENTATION_PRESENTER.credits_source_tilemap(self)

func get_credits_source_group_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.credits_source_group_text(self)

func get_credits_detail_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.credits_detail(self)

func get_credits_page_index_text() -> String:
	return ENDING_PRESENTATION_PRESENTER.credits_page_index_text(self)
...
func get_credits_slide_group() -> int:
	var page_start := 0
	var groups := CREDITS_CATALOG.slide_groups()
	for group_index in range(groups.size()):
		page_start += int(groups[group_index])
...
func get_special_stage_pause_text() -> String:
	return SPECIAL_STAGE_PRESENTER.pause_text(self)
...
func get_special_stage_title_text() -> String:
	return SPECIAL_STAGE_PRESENTER.title_text(self)

func get_special_stage_source_tilemap() -> String:
	return SPECIAL_STAGE_PRESENTER.source_tilemap(self)

func get_special_stage_prompt_text() -> String:
	return SPECIAL_STAGE_PRESENTER.prompt_text(self)

func get_special_stage_detail_text() -> String:
	return SPECIAL_STAGE_PRESENTER.detail_text(self)

func get_special_stage_run_display_text(motion_label: String, robo_progress: int) -> String:
	return SPECIAL_STAGE_PRESENTER.run_display_text(self, motion_label, robo_progress)

func get_special_stage_result_display_text() -> String:
	return SPECIAL_STAGE_PRESENTER.result_display_text(self)

func get_special_stage_motion_text() -> String:
	return SPECIAL_STAGE_PRESENTER.motion_text(self)

func get_special_stage_new_label() -> String:
	return SPECIAL_STAGE_PRESENTER.new_label(self)
...
func _advance_credits_end_story(delta: float) -> void:
	...
	var delays := CREDITS_CATALOG.end_story_delays()
	if _credits_end_story_frame >= 1 and _credits_end_story_frame <= delays.size():
		_credits_end_story_timer = float(delays[_credits_end_story_frame - 1]) / 60.0
...
func get_time_attack_results_progress() -> float:
	return TIME_ATTACK_RESULTS_PRESENTER.progress(self)

func get_time_attack_results_title_text() -> String:
	return TIME_ATTACK_RESULTS_PRESENTER.title_text(self)

func get_time_attack_results_time_text() -> String:
	return TIME_ATTACK_RESULTS_PRESENTER.time_text(self)

func get_time_attack_results_medal_text() -> String:
	return TIME_ATTACK_RESULTS_PRESENTER.medal_text(self)

func get_time_attack_results_record_text() -> String:
	return TIME_ATTACK_RESULTS_PRESENTER.record_text(self)

func get_time_attack_results_prompt_text() -> String:
	return TIME_ATTACK_RESULTS_PRESENTER.prompt_text(self)
...
func _get_story_character_unlock_for_level(level_index: int) -> int:
	...
	return STORY_UNLOCK_SYSTEM.character_unlock_for_level(level_index)
...
func _get_selected_zone_index() -> int:
	...
	return CHAOS_EMERALD_PROGRESSION_SYSTEM.selected_zone(_selected_level_index)
...
func _refresh_story_unlocks() -> void:
	...
	_extra_zone_status = state.extra_zone_status
	_unlocked_level_index = state.unlocked_level_index

func get_chaos_emerald_count() -> int:
	return CHAOS_EMERALD_PROGRESSION_SYSTEM.count(_get_selected_chaos_emerald_mask())
...
func _sanitize_profile_name(raw_name: Variant) -> Array:
	return SAVE_PROFILE_SANITIZER.profile_name(raw_name)

func _sanitize_button_bindings(raw_bindings: Variant) -> Array:
	return SAVE_PROFILE_SANITIZER.button_bindings(raw_bindings, PROFILE_CATALOG.default_button_bindings())

func _sanitize_multiplayer_record_rows(raw_rows: Variant) -> Array:
	return SAVE_PROFILE_SANITIZER.multiplayer_rows(raw_rows, _get_default_multiplayer_record_rows())

func _multiplayer_record_identity(name: String) -> int:
	return SAVE_PROFILE_SANITIZER.multiplayer_identity(name)

func _sanitize_multiplayer_record_totals(raw_totals: Variant) -> Dictionary:
	return SAVE_PROFILE_SANITIZER.multiplayer_totals(raw_totals, _get_default_multiplayer_record_totals())

func _insert_or_promote_multiplayer_record(name: String, player_id: int = 0) -> int:
	return MULTIPLAYER_RECORD_SYSTEM.insert_or_promote(_multi_record_rows, name, player_id)

func _record_own_multiplayer_result(result_key: String) -> void:
	MULTIPLAYER_RECORD_SYSTEM.record_own_result(_multiplayer_record_totals, result_key)
...
func _sanitize_time_attack_best_times(raw_value: Variant) -> Dictionary:
	return SAVE_PROFILE_SANITIZER.time_attack_best_times(raw_value)

func _sanitize_time_attack_record_tables(raw_value: Variant) -> Dictionary:
	return SAVE_PROFILE_SANITIZER.time_attack_record_tables(raw_value)

func _get_default_tiny_chao_roster() -> Array:
	return CHARACTER_CATALOG.default_tiny_chao_roster()
