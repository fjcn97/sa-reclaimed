...
static func rows(bridge: Object) -> Array:
	...
	var multi_pak: String = bridge.language_text("MULTI-PAK", "MULTI-PAK", "MULTI-PAK", "MULTI-PAK", "MULTI-PAK")
	var single_pak: String = bridge.language_text("SINGLE-PAK", "SINGLE-PAK", "SINGLE-PAK", "SINGLE-PAK", "SINGLE-PAK")
	var ready: String = bridge.language_text("READY", "BEREIT", "PRET", "LISTO", "PRONTO")
	var name_required: String = bridge.language_text("NAME REQ", "NAME NOETIG", "NOM REQUIS", "NOMBRE REQ", "NOME RICHIESTO")
	var has_name: bool = bridge.has_profile_name()
	return [
		{"name": multi_pak, "description": bridge.language_text("2-4 PLAYERS USING ONE GAME PAK EACH", "2-4 SPIELER MIT JE EINEM GAME PAK", "2-4 JOUEURS AVEC UN GAME PAK CHACUN", "2-4 JUGADORES CON UN GAME PAK CADA UNO", "2-4 GIOCATORI CON UN GAME PAK CIASCUNO"), "status": ready if has_name else name_required, "available": has_name, "selected": title_navigation.menu_index == 0},
		{"name": single_pak, "description": bridge.language_text("HOST A DOWNLOAD MATCH FROM ONE GAME PAK", "DOWNLOAD-MATCH MIT EINEM GAME PAK HOSTEN", "HEBER UNE PARTIE TELECHARGEE DEPUIS UN GAME PAK", "ALBERGAR UNA PARTIDA DESCARGADA DESDE UN GAME PAK", "OSPITA UNA PARTITA DOWNLOAD DA UN GAME PAK"), "status": ready if has_name else name_required, "available": has_name, "selected": title_navigation.menu_index == 1},
	]

static func title_text(bridge: Object) -> String:
	return bridge.language_text("SELECT PAK MODE", "PAK-MODUS", "MODE PAK", "MODO PAK", "MODALITA PAK")
...
static func prompt_text(bridge: Object) -> String:
	...
	return bridge.language_text("CHOOSE A LINK STYLE", "LINK-ART AUSWAEHLEN", "CHOISIR UN MODE DE LIAISON", "ELIGE UN TIPO DE ENLACE", "SCEGLI UN TIPO DI COLLEGAMENTO")
...
static func summary_text(bridge: Object) -> String:
	...
	var profile_label: String = bridge.language_text("PROFILE", "PROFIL", "PROFIL", "PERFIL", "PROFILO")
