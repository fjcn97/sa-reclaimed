...
func _ensure_chrome() -> void:
	var chrome := ensure_simple_list_chrome({"glow": Color(0.26, 0.54, 0.94, 0.10), "panel": Color(0.98, 0.99, 1.0, 0.99), "accent": Color(0.18, 0.54, 0.94, 0.96), "footer": Color(0.96, 0.98, 1.0, 0.99)})
